...
/* Bascule automatique pour le Mode Sombre via le navigateur/système */
...
/* AJOUT POUR LE TEXTE DU CHATBOT */
[data-testid="stChatMessage"] [data-testid="stMarkdownContainer"] p,
[data-testid="stChatMessage"] [data-testid="stMarkdownContainer"] li {
    color: var(--text-llm) !important;
}

/* CORRECTIONS : Suppression du forçage de --bg et --text */
html, body, [class*="css"] {
...
.result-card.pdf { border-left: 3px solid var(--warn); }
...
.tag-pdf { background: #3a2a1a; color: var(--warn); }
