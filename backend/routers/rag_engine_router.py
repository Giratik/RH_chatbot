...
from .registry_qdrant_helper import list_registry, registry_for_tool_calling
import os
CHATBOT_ROLE = os.environ.get("CHATBOT_ROLE", "RH")
...
def rewrite_endpoint(req: RewriteRequest):
    ...
    try:
        rewritten = rewrite_query(ollama_client, req.model, req.query, req.context_size, req.chat_history)
